...
viewMain main =
    [ main_ [ Style.ids.overview ]
        [ menu []
            [ li []
                [ Links.linkButton
                    { url = Links.frontendPage <| Addresses.Frontend.projects.address <| ()
            ...
            , li []
                [ Links.linkButton
                    { url = Links.frontendPage <| Addresses.Frontend.dashboards.address <| ()
                    , attributes = [ Style.classes.button.overview ]
            ...
            , li []
                [ Links.linkButton
                    { url = Links.frontendPage <| Addresses.Frontend.settings.address <| ()
                    , attributes = [ Style.classes.button.overview ]
