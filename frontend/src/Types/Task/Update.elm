...
type alias ClientInput =
    ...
    , unit : Maybe String
    , counting : Bool
    , progressUpdate : Types.Progress.Update.ClientInput
    }
...
lenses :
    ...
    , progressUpdate : Lens ClientInput Types.Progress.Update.ClientInput
    }
lenses =
...
from task =
    ...
    , progressUpdate = Types.Progress.Update.from task.progress
    }
...
toGraphQLInput clientInput =
    ...
    , progressUpdate = clientInput.progressUpdate |> Types.Progress.Update.toGraphQLInput
    }
