...
trait Tables {
  ...
  lazy val schema: profile.SchemaDescription = Array(Dashboard.schema, DashboardEntry.schema, LoginAttempt.schema, Project.schema, Session.schema, Task.schema, User.schema).reduceLeft(_ ++ _)
